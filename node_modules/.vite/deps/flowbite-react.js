...
function FloatingPortal(props) {
  ...
  return React3.createElement(PortalContext.Provider, {
    ...
    style: HIDDEN_STYLES
  }), portalNode && ReactDOM2.createPortal(children, portalNode), shouldRenderGuards && portalNode && React3.createElement(FocusGuard, {
    "data-type": "outside",
    ref: afterOutsideRef,
    onFocus: (event) => {
      if (isOutsideEvent(event, portalNode)) {
...
var DatepickerRender = ({
  ...
  const effectiveDefaultView = (0, import_react25.useMemo)(() => {
  ...
  const [selectedDate, setSelectedDate] = (0, import_react25.useState)(value ?? initialDate);
  const [viewDate, setViewDate] = (0, import_react25.useState)(value ?? effectiveDefaultView);
